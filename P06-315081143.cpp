...
// average normals
	GLfloat cubo_vertices[] = {
		//						cordenadas de la tectura donde se le deja un 0.1 unidades
		// front				que no tome el pixel de la linea
		//x		y		z		S		T			NX		NY		NZ
		...
		0.5f,  0.5f,  -0.5f,	0.74f,	0.324,		-1.0f,	0.0f,	0.0f,
...
int main()
{
	...
	Dado_M = Model();
	Dado_M.LoadModel("Models/DadoNumero.obj");
	//Practica 
	Delorian_M = Model();
...
/*
		...
		*/
		...
		texturizar el cofre de su propio modelo de coche
		*/
